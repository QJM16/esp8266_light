...
//********************需要修改的部分*******************//
const char* ssid = "xxxxxxxx";           //修改，你的路由去WIFI名字
const char* password = "xxxxxxxxxxx";     //你的WIFI密码
#define ID_MQTT  "xxxxxxxxxxxxxxxxxxx"     //用户私钥，控制台获取
const char*  topic = "offlight002";        //主题名字，可在巴法云控制台自行创建，名称随意
const int B_led = 0;       //单片机LED引脚值，esp01s 为0
//**************************************************//
